...
EVENT_MAPPER = {
	"orders/create": "ecom_bridge.integrations.shopify.order.sync_sales_order",
	"orders/paid": "ecom_bridge.integrations.shopify.invoice.prepare_sales_invoice",
	"orders/fulfilled": "ecom_bridge.integrations.shopify.fulfillment.prepare_delivery_note",
	"orders/cancelled": "ecom_bridge.integrations.shopify.order.cancel_order",
	"orders/partially_fulfilled": "ecom_bridge.integrations.shopify.fulfillment.prepare_delivery_note",
}
