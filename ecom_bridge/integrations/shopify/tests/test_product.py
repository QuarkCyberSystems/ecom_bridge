...
from ecom_bridge.integrations.shopify.product import ShopifyProduct
...
class TestProduct(TestCase):
	...
	def test_variant_id_mapping(self):
		...
		from ecom_bridge.integrations.shopify.product import map_erpnext_variant_to_shopify_variant
