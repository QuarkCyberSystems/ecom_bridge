...
from ecom_bridge.integrations.shopify.customer import ShopifyCustomer
from ecom_bridge.integrations.shopify.product import create_items_if_not_exist, get_item_code
from ecom_bridge.integrations.shopify.utils import create_shopify_log
from ecom_bridge.utils.price_list import get_dummy_price_list
from ecom_bridge.utils.taxation import get_dummy_tax_category
...
def create_order(order, setting, company=None):
	...
	from ecom_bridge.integrations.shopify.fulfillment import create_delivery_note
	from ecom_bridge.integrations.shopify.invoice import create_sales_invoice
