...
from ecom_bridge.ecom_bridge.doctype.ecommerce_integration_log.ecommerce_integration_log import (
	create_log,
)
...
def migrate_from_old_connector(payload=None, request_id=None):
	...
	if request_id:
		...
		log = create_shopify_log(
			status="Queued", method="ecom_bridge.integrations.shopify.utils.migrate_from_old_connector",
		)
